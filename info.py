...
API_ID = int(environ.get('API_ID', '25152772'))
API_HASH = environ.get('API_HASH', '58f97c6084ea9e5d741cabace366eb57')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002239819427'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5054224811').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mujju300:mujju123fir@cluster0.gs1oabl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Mogodb")
